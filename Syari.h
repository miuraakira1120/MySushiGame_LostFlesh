...
//    int hGoalModel;  //ゴールのモデル番号
//
//    int lowest;     //一番低い角の配列の位置
//    int highest;    //一番高い角の配列の位置
//    int rightest;   //一番右の角の配列の位置
//    int leftest;    //一番左の角の配列の位置
//    int foremost;   //一番奥の角の配列の位置
//    int innermost;  //一番前の角の配列の位置
//    RayCastData GoalData;
//    RayCastData prevPosData;
//    RayCastData prevLowPosData;
//    RayCastData nowPosData[6];
//    RayCastData nowLowPosData;
//    RayCastData nowUpPosData;
//    RayCastData nowLeftPosData;
//    RayCastData nowRightPosData;
//    RayCastData nowBackPosData;
//    RayCastData nowFrontPosData;
